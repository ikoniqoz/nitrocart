		...
		<div class="content">
			...
			<div class="one_full" id="">
				...
				<span style='float:right'>
					<a href='{{x:uri x='ADMIN'}}/shipping_zones/showall' class='btn green'>Show ALL</a><br/>
			...
			<div class="one_full" id="">			
								...
								<tbody>
									<?php foreach ($countries as $item): ?>
										<tr>
											...
											<td class="actions">
												<?php if ($item->enabled):?>
													<a class='zone_linker button orange' href="{{x:uri x='ADMIN'}}/shipping_zones/country/0/<?php echo $item->id;?>">Active</a>
												<?php else:?>
						...
						<?php else: ?>
							<div class="no_data">System error, your NitroCart system can not find any countries or shipping zones.</div>
						<?php endif; ?>
				</div>
...
<script>
	...
	function link_shipping_zone(button, is_linked, row_id)
	{
		...
		var url = '<?php echp NC_ADMIN_ROUTE;?>/shipping_zones/country/'+toggle+'/' + row_id;
